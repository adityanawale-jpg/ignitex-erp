-- ============================================================
-- 102_min_max_planning_master.sql
-- Min/Max Planning Master: table + project_config queries
-- Menu MM_MIN_MAX (id=36) already exists — no menu insert needed.
-- Run after 101_user_menu_permission_override.sql
-- ============================================================

BEGIN;

-- ══════════════════════════════════════════════════════════════
-- 1. MIN/MAX PLANNING MASTER TABLE
-- ══════════════════════════════════════════════════════════════
