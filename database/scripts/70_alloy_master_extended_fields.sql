-- ============================================================
-- 70_alloy_master_extended_fields.sql
-- Extend alloy_master with production/commercial fields,
...
-- ── 4. Update alloy_create ($1–$29 fields, $30 = user_id for both created_by/updated_by) ──
UPDATE project_config SET key_value =
...
-- ── 5. Update alloy_update ($1–$28 fields, $29 = updated_by, $30 = id) ──
UPDATE project_config SET key_value =
