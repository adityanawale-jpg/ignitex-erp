-- ══════════════════════════════════════════════════════════════
-- 116_customer_payment_term_lookup.sql
-- Master Management → Customer Master → Credit Limit step
--   Seed PAYMENT_TERM lookup values so Payment Terms is a dropdown
--   (LOV) instead of free text, matching CUSTOMER_TYPE / GST_TREATMENT.
-- ══════════════════════════════════════════════════════════════
