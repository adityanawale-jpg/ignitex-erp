-- ══════════════════════════════════════════════════════════════
-- 123_variant_lead_time.sql
-- Master Management → FG Master / Finding Master →
--   Variant Management → Variant popup → Manufacturing tab
--   Adds a Lead Time dropdown backed by the existing LEAD_TIME
--   master_lookup type (7 / 14 / 21 / 28 Days).
--
--   Adds fg_item_variant.lead_time and fin_item_variant.lead_time
--   and threads :lead_time through the four variant CRUD query
--   templates in project_config.
--
-- Reference copy of prisma migration 20260728000003_variant_lead_time
-- Run after 122_customer_price_plating_amt.sql
-- ══════════════════════════════════════════════════════════════
