-- Migration 105: Inventory Structure Master: table + project_config queries + menu + lookup seeds
...
INSERT INTO master_lookup (lookup_type, lookup_code, lookup_name, display_order, is_active) VALUES
  ...
  ('INV_BU', 'RCL-FF', 'First Floor - KIT Marshal/Dispatch',        2, TRUE),
  ('INV_BU', 'RCL-SF', 'Second Floor - Depot',                      3, TRUE),
  ('INV_BU', 'RCL-ZB', 'First Floor - Zaveri Bazar - Sales Office', 4, TRUE)
