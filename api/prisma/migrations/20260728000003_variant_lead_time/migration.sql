...
-- Add a Lead Time dropdown (lookup type LEAD_TIME) to the
-- "Add New Variant" Manufacturing tab on FG Master and Finding
-- Master, and update the four variant CRUD queries to carry it.
