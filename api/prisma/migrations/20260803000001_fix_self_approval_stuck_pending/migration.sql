-- ============================================================
-- 20260803000001_fix_self_approval_stuck_pending
-- Repair records left in PENDING_APPROVAL by the self-approval bug.
-- Raw-SQL reference copy: database/scripts/130_fix_self_approval_stuck_pending.sql
--
...
-- Safe to re-run.
-- ============================================================
-- (No BEGIN/COMMIT — Prisma wraps each migration in a transaction.)
